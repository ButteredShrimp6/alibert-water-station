<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VerifyEmail.aspx.cs" Inherits="sample.VerifyEmail" %>
      ...
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-container-style u-group u-radius-36 u-shape-round u-white u-group-1">
          <div class="u-container-layout u-container-layout-1">
            <h3 class="u-text u-text-default u-text-1">Verify E-Mail</h3>
            
            <h5 class="u-text u-text-default u-text-3">Verify E-Mail<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="codeTxtBox" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
              </h5>

            

            <asp:TextBox ID="codeTxtBox" runat="server" CssClass="auto-style1" Width="294px"></asp:TextBox>
              <div align="center">
                  <p class="auto-style2">
            ...
            <asp:Button ID="verifyBtn" runat="server" href="https://nicepage.com/website-mockup" class="u-align-center u-btn u-btn-round u-button-style u-radius-11 u-btn-1" Height ="12%" Width="100%" Text="Verify E-Mail" OnClick="verifyBtn_Click"></asp:Button>
                </div>
