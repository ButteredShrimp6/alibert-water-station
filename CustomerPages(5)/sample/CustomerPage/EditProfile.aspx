<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditProfile.aspx.cs" Inherits="sample.WebForm3" %>
...
<link rel="stylesheet" href="EditProfile.css" media="screen">
  ...
  <body class="u-body u-xl-mode" data-lang="en"> <header class="u-border-2 u-border-palette-1-dark-1 u-clearfix u-header u-palette-1-light-3 u-header" id="sec-650f"><div class="u-clearfix u-sheet u-sheet-1" style="left: 0px; top: 0px">
    ...
    <section class="u-clearfix u-image u-section-1" id="sec-af0f" data-image-width="1300" data-image-height="1300">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h3 class="u-align-center u-text u-text-palette-1-dark-3 u-text-1">M​y Account</h3>
        <div class="u-container-style u-group u-radius-30 u-shape-round u-white u-group-1">
          <div class="u-container-layout u-container-layout-1">
            <%--<a href="HomePage.html" class="u-active-palette-1-dark-1 u-border-2 u-border-hover-palette-1-base u-border-palette-1-base u-btn u-btn-round u-button-style u-grey-5 u-hover-palette-1-light-1 u-radius-50 u-btn-1">Update Profile</a>--%>         
            
              <p class="u-text u-text-default u-text-2" ><strong>Last Name</strong></p>
            <p class="u-text u-text-default u-text-3"><strong>First Name</strong></p>                       
              <asp:TextBox runat="server" ID="fname" CssClass="auto-style3"></asp:TextBox><br/> 
              <asp:TextBox runat="server" ID="lname" CssClass="auto-style4"></asp:TextBox><br/> 
            <p class="u-text u-text-default u-text-3"><strong>Mobile Number</strong></p>
               <asp:TextBox runat="server" ID="mobNum" CssClass="auto-style3"></asp:TextBox><br/>          
            <asp:Button CssClass="u-active-palette-1-dark-1 u-border-2 u-border-hover-palette-1-base u-border-palette-1-base u-btn u-btn-round u-button-style u-grey-5 u-hover-palette-1-light-1 u-radius-50 u-btn-1" ID="Button1" runat="server" Text="Update Profile" OnClick="Button1_Click" /> <br />

               <asp:Button CssClass="u-active-palette-1-dark-1 u-border-2 u-border-hover-palette-1-base u-border-palette-1-base u-btn u-btn-round u-button-style u-grey-5 u-hover-palette-1-light-1 u-radius-50 u-btn-1" ID="Button3" runat="server" Text="Change Password" OnClick="Button3_Click" /><br />
          </div>
        </div>
      </div>
    </section>   
