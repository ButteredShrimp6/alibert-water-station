<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransactionHistory.aspx.cs" Inherits="sample.TransactionHistory" %>
      ...
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-container-style u-group u-radius-30 u-shape-round u-white u-group-1">
          <div class="u-container-layout u-valign-top u-container-layout-1">
            <h3 class="u-text u-text-default u-text-1">Transaction History</h3>
                ...
                <ItemTemplate>
                    <div class="th-order">                       
                        <div class="th-order-details-container">
                            ...
                            <div class="th-order-sections">
                                <label class="th-product-label">Delivery Date:</label>
                                <asp:Label CssClass="th-order-value-label" ID="LblDeliveryDate" runat="server" Enabled="false" Text='<%# Eval("orderDate") %>'></asp:Label>
                            </div>
                             <div class="th-order-sections">
                                <label class="th-product-label">Delivery Date:</label>
