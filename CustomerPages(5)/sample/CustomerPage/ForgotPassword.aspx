<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="sample.ForgotPassword" %>
      ...
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-container-style u-group u-radius-36 u-shape-round u-white u-group-1">
          <div class="u-container-layout u-container-layout-1">
            ...
            <h5 class="u-text u-text-default u-text-3">Email Address<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="emailTxtBox" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
              </h5>

            

            <asp:TextBox ID="emailTxtBox" runat="server" CssClass="auto-style1" Width="294px"></asp:TextBox>
              <div align="center">
                  <p class="auto-style2">
            ...
            <asp:Button ID="forgotBtn" runat="server" href="https://nicepage.com/website-mockup" class="u-align-center u-btn u-btn-round u-button-style u-radius-11 u-btn-1" Height ="12%" Width="100%" OnClick="forgotBtn_Click" Text="Forgot Password"></asp:Button>
                </div>
